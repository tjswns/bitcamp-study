...
public class ServerApp {
  ...
  private void prepareMenu() {
    ...
    MenuGroup stylingMenu = new MenuGroup("/styling", "스타일");
    stylingMenu.add("/styling/add", "등록", facadeListener);
    stylingMenu.add("/styling/list", "목록", facadeListener);
    stylingMenu.add("/styling/detail", "조회", facadeListener);
    stylingMenu.add("/styling/update", "변경", facadeListener);
    stylingMenu.add("/styling/delete", "삭제", facadeListener);
    mainMenu.add(stylingMenu);

    MenuGroup accMenu = new MenuGroup("/acc", "악세사리");
    accMenu.add("/acc/add", "등록", facadeListener);
    accMenu.add("/acc/list", "목록", facadeListener);
    accMenu.add("/acc/detail", "조회", facadeListener);
    accMenu.add("/acc/update", "변경", facadeListener);
    accMenu.add("/acc/delete", "삭제", facadeListener);
