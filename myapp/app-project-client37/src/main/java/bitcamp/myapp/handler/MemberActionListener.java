...
public interface MemberActionListener extends ActionListener {
  ...
  static void inputTop(Member m, BreadcrumbPrompt prompt) {
  ...
  static void inputPants(Member m, BreadcrumbPrompt prompt) {
    if (m.getGender() == Member.MALE) {
      loop: while (true) {
        String menuNo =
  ...
  static void inputShoes(Member m, BreadcrumbPrompt prompt) {
    if (m.getGender() == Member.MALE) {
      loop: while (true) {
        String menuNo =
