...
insert into myapp_acc(acc_no, style, choose, size, writer, password, category)
  values(11, '데일리', '목걸이', '9호', 1, '1111', 1);
insert into myapp_acc(acc_no, style, choose, size, writer, password, category)
  values(12, '힙', '반지', '10호', 2, '1111', 1);
insert into myapp_acc(acc_no, style, choose, size, writer, password, category)
  values(13, '스트릿', '반지', '11호', 3, '1111', 1);
insert into myapp_acc(acc_no, style, choose, size, writer, password, category)
  values(14, '데일리', '안경', '11호', 3, '1111', 1);
insert into myapp_acc(acc_no, style, choose, size, writer, password, category)
  values(15, '스트릿', '목걸이', '9호', 4, '1111', 2);
  
  -- myapp_styling 테이블 예제 데이터
insert into myapp_styling(styling_no, style, brand, fit, writer, password, category)
  values(11, '데일리', '구찌', '오버 핏', 1, '1111', 1);
insert into myapp_styling(styling_no, style, brand, fit, writer, password, category)
  values(12, '파티', '프라다', '슬림 핏', 2, '1111', 1);
insert into myapp_styling(styling_no, style, brand, fit, writer, password, category)
  values(13, '데이트', '샤넬', '스텐다드 핏', 2, '1111', 1);
insert into myapp_styling(styling_no, style, brand, fit, writer, password, category)
  values(14, '데일리', '구찌', '슬림 핏', 3, '1111', 1);
insert into myapp_styling(styling_no, style, brand, fit, writer, password, category)
  values(15, '파티', '샤넬', '오버 핏', 4, '1111', 2);
