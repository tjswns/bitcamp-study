...
public interface AccActionListener extends ActionListener {
  ...
  static void inputStyle(Acc acc, BreadcrumbPrompt prompt) throws IOException {
    loop: while (true) {
  ...
  static void inputChoose(Acc acc, BreadcrumbPrompt prompt) throws IOException {
    loop: while (true) {
      String menuNo = prompt.inputString(
          "좋아하는 악세사리:\n" + "  1. 목걸이\n" + "  2. 반지\n" + "  3. 안경\n" + "  4. 그 외\n" + "> ");
  ...
  static void inputSize(Acc acc, BreadcrumbPrompt prompt) throws IOException {
    loop: while (true) {
      String menuNo = prompt.inputString(
          "좋아하는 사이즈:\n" + "  1. 9호\n" + "  2. 10호\n" + "  3. 11호\n" + "  4. 그 외\n" + "> ");
  ...
  static String inputOtherSize(BreadcrumbPrompt prompt) throws IOException {
