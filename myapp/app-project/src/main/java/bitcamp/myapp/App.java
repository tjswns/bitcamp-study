...
public class App {
  ...
  public static void main(String[] args) {
    ...
    while (true) {
      ...
      if (menuNo.equals("99")) {
        ...
        accHandler.inputBoard();
      } else if (menuNo.equals("12")) {
        accHandler.printBoard();
      } else if (menuNo.equals("13")) {
        accHandler.viewBoard();
      } else if (menuNo.equals("14")) {
        accHandler.updateBoard();
      } else if (menuNo.equals("15")) {
        accHandler.deleteBoard();
      } else {
  ...
  static void printMenu() {
    ...
    System.out.println("11. 스타일등록");
    System.out.println("12. 스타일목록");
    System.out.println("13. 스타일조회");
    System.out.println("14. 스타일변경");
    System.out.println("15. 스타일삭제");
