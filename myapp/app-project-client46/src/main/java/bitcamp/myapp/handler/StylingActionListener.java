...
public interface StylingActionListener extends ActionListener {
  ...
  static void inputStyle(Styling styling, BreadcrumbPrompt prompt) {
    loop: while (true) {
      String menuNo =
  ...
  static void inputBrand(Styling styling, BreadcrumbPrompt prompt) {
    loop: while (true) {
  ...
  static void inputFit(Styling styling, BreadcrumbPrompt prompt) {
    loop: while (true) {
      String menuNo = prompt.inputString(
          "좋아하는 브랜드:\n" + "  1. 오버핏\n" + "  2. 슬림핏\n" + "  3. 스탠다드핏\n" + "  4. 그 외\n" + "> ");
  ...
  static String inputOtherFit(BreadcrumbPrompt prompt) {
