...
public class Exam01 {
  ...
  public static void main(String[] args) {
    ...
    /*
     * Car c1 = new Car(); c1.setModel("티코"); c1.setMaker("비트자동차");
     * c1.setCc(Integer.valueOf("890")); c1.setAuto(Boolean.valueOf("true"));
     *
     * CustomDateEditor cde = new CustomDateEditor(); cde.setAsText("2021-6-1");
     *
